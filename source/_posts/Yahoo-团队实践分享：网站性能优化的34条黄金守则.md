title: 'Yahoo!团队实践分享：网站性能优化的34条黄金守则'
...
YUI CSS utilities可以给你的布局带来巨大帮助：grids.css可以帮你实现整体布局，font.css和reset.css可以帮助你移除浏览器默认格式。它提供了一个重新审视你页面中标签的机会，比如只有在语意上有意义时才使用div，而不是因为它具有换行效果才使用它。
